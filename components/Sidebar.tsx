              ...
              <div className="flex-1 p-8 overflow-y-auto text-sm text-gray-400 leading-relaxed custom-scrollbar prose prose-invert">
                 {showLegalView === 'privacy' ? (
                   <div className="space-y-4">
                     ...
                     <p>All API keys entered in the application are stored exclusively on your local device (localStorage) and are never sent to our servers.</p>
                     <p className="pt-4 border-t border-white/5">Contact: vyncuslim121@gmail.com</p>
                   </div>
                 ) : (
                   <div className="space-y-4">
                     <p>By using Nexus Core AI, you agree to these terms. This application is provided as-is for experimental AI interaction purposes.</p>
                     <p>You are responsible for the content you generate and for ensuring you have valid API keys for the providers you use (OpenAI, Google, Anthropic).</p>
                     <p>We are not responsible for any outputs generated by the AI models, which remain the property and responsibility of their respective providers.</p>
                   </div>
                 )}
              </div>
           </div>
